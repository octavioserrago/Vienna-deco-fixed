...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-gray-400 text-start text-base font-medium text-gray-900 bg-grisrojo focus:outline-none focus:text-gray-900 focus:bg-gray-700 focus:border-gray-900 transition duration-150 ease-in-out'
