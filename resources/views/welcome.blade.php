...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        ...
        <!--<img id="background" class="absolute inset-0 w-full h-full object-cover filter" src="{{ asset('images/vienna-deco-fondo.jpg') }}" alt="background" />-->
        ...
        <section class="bg-crema text-gray-700">
            <div class="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                    ...
                    <p class="mt-6 mb-8 text-lg sm:mb-12">En Vienna Deco, nos especializamos en la fabricación artesanal de mesas, mesadas y artículos únicos que combinan mármol de alta calidad con bases de hierro diseñadas a medida. Nuestro objetivo es transformar materiales nobles en piezas funcionales y elegantes para tu hogar o negocio. Ofrecemos también tapas de mármol y accesorios decorativos, adaptados a tus necesidades y estilo. Creamos con pasión, priorizando diseño, durabilidad y exclusividad.</p>
